...
async function syncRealData() {
    ...
    try {
        ...
        // 3. Limpiar matrículas previas de Santiago para el periodo actual (ID 2)
        ...
        // 4. Crear las materias reales y sus cursos
        const materiasReales = [
            { nombre: 'Gestión de Servicios en TIC', codigo: 'DPCI-23073', creditos: 3, nrc: '13424' },
            { nombre: 'Metodologías Ágiles en Software', codigo: 'DPCI-23105', creditos: 3, nrc: '13425' },
            { nombre: 'Electiva de Formación Social II', codigo: 'DPCS-32139', creditos: 2, nrc: '13776' },
            { nombre: 'Trabajo de Grado I', codigo: 'DPCI-22153', creditos: 2, nrc: '13816' },
            { nombre: 'Electiva de Profundización IV', codigo: 'DPCI-23038', creditos: 3, nrc: '14041' },
            { nombre: 'Electiva de Profundización II', codigo: 'DPCI-23036', creditos: 3, nrc: '14273' }
        ];
        ...
        for (const m of materiasReales) {
            ...
            // Crear curso si no existe para este periodo y NRC
            db.prepare('INSERT OR IGNORE INTO cursos (materia_id, docente_id, periodo_id, nrc, estado) VALUES (?, ?, 2, ?, "activo")').run(materiaId, arangel.id, m.nrc);
